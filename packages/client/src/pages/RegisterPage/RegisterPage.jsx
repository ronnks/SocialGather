...
const RegisterPage = () => {
  ...
  const handleInputChange = (event) => {
    /* const getEmailValidator = event.target.name === email;
    const getPasswordValidator = event.target.name === password;

    if (
      (getEmailValidator && validators.validateEmail(event.target.value)) ||
      (getPasswordValidator && validators.validatePassword(event.target.value))
    ) {
      setData({
        ...data,
      ...
      const error = new Error("Password or Email Invalid");
      setData({
        ...data,
